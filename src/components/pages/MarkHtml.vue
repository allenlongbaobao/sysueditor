...
.markDiv >>> p, blockquote, table, pre {
  margin: 15px 0; }
...
.markDiv >>> #wrapper > h2:first-child {
  margin-top: 0;
  padding-top: 0; }
.markDiv >>> #wrapper > h1:first-child {
  margin-top: 0;
  padding-top: 0; }
  #wrapper > h1:first-child + h2 {
    margin-top: 0;
    padding-top: 0; }
.markDiv >>> #wrapper > h3:first-child, #wrapper > h4:first-child, #wrapper > h5:first-child, #wrapper > h6:first-child {
  margin-top: 0;
  padding-top: 0; }

.markDiv >>> a:first-child h1, a:first-child h2, a:first-child h3, a:first-child h4, a:first-child h5, a:first-child h6 {
  margin-top: 0;
  padding-top: 0; }

.markDiv >>> h1 + p, h2 + p, h3 + p, h4 + p, h5 + p, h6 + p, ul li > :first-child, ol li > :first-child {
  margin-top: 0; }
...
.markDiv >>> .highlight .c {
  color: #998;
  font-style: italic; }
.markDiv >>> .highlight .err {
  color: #a61717;
  background-color: #e3d2d2; }
.markDiv >>> .highlight .k, .highlight .o {
  font-weight: bold; }
.markDiv >>> .highlight .cm {
  color: #998;
  font-style: italic; }
.markDiv >>> .highlight .cp {
  color: #999;
  font-weight: bold; }
.markDiv >>> .highlight .c1 {
  color: #998;
  font-style: italic; }
.markDiv >>> .highlight .cs {
  color: #999;
  font-weight: bold;
  font-style: italic; }
.markDiv >>> .highlight .gd {
  color: #000;
  background-color: #fdd; }
  .highlight .gd .x {
    color: #000;
    background-color: #faa; }
.markDiv >>> .highlight .ge {
  font-style: italic; }
.markDiv >>> .highlight .gr {
  color: #a00; }
.markDiv >>> .highlight .gh {
  color: #999; }
.markDiv >>> .highlight .gi {
  color: #000;
  background-color: #dfd; }
  .highlight .gi .x {
    color: #000;
    background-color: #afa; }
.markDiv >>> .highlight .go {
  color: #888; }
.markDiv >>> .highlight .gp {
  color: #555; }
.markDiv >>>.highlight .gs {
  font-weight: bold; }
.highlight .gu {
  color: #800080;
  font-weight: bold; }
...
.highlight .bp {
  color: #999; }
.markDiv >>> .highlight .vc, .highlight .vg, .highlight .vi {
  color: #008080; }
.highlight .il {
  color: #099; }
.highlight .gc {
